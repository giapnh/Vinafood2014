...
public class DiscoveryCuisineWithHelthActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.discovery_cuisine_helth_main);
	...
	public void onSearchButtonClick(View v) {
		Intent intent = new Intent(DiscoveryCuisineWithHelthActivity.this,
				DiscoveryCuisineWithHelthTopicSearchActivity.class);
	...
	public class DiscoveryHelthAdapter extends BaseAdapter {
		...
		public View getView(final int paramInt, View convertView,
			...
			/* Animation google plus alike */
			// Animation animation = AnimationUtils.loadAnimation(ctx,
			// (paramInt > lastPosition) ? R.anim.up_from_bottom
